...
SET NODE_DOWNLOAD_URL=https://nodejs.org/dist/v16.13.2/node-v16.13.2-x64.msi
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/snakes-and-ladders-game/releases/download/v1.0.0/snakes-and-ladders-game.zip
SET REPO_NAME=snakes-and-ladders-game.zip
SET EXTRACTED_REPO_DIR=snakes-and-ladders-game
...
msiexec /i node-v%NODE_VERSION%-x64.msi /quiet InstallAllUsers=0 PrependPath=1 Include_test=0 TargetDir=%NODE_LOCATION%
ECHO==========================================================================
